...
| :-----------: | ----------- |----------- |
|[Megaline Revenue Showdown: Surf vs. Ultimate](https://github.com/BradyQuack/Megaline-Revenue-Showdown-Surf-vs.-Ultimate) | Analyze data from a sample of 500 Megaline clients to evaluate the usage patterns of customers on both plans and determine which plan generates more revenue| pandas, matplotlib, numpy, scipy |
